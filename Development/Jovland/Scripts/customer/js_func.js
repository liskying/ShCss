$(function() {
	...
	$('.faq_list .filter .ContainerSecuringSystem').on('click', function(){
		$('#faq .CarLashingSystem').hide();
		$('#faq .TimberLashing').hide();
		$('#faq .ContainerSecuringSystem').show();
	});
	$('.faq_list .filter .CarLashingSystem').on('click', function(){
		$('#faq .ContainerSecuringSystem').hide();
		$('#faq .TimberLashing').hide();
		$('#faq .CarLashingSystem').show();
	});
	$('.faq_list .filter .TimberLashing').on('click', function(){
		$('#faq .ContainerSecuringSystem').hide();
		$('#faq .CarLashingSystem').hide();
		$('#faq .TimberLashing').show();
	});
}); 